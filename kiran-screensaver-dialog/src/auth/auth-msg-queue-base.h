...
class AuthMsgQueueBase : public QObject
{
    Q_OBJECT
public:
    ...
    virtual void appendAuthCompleteMsg(bool authRes,const QString& msg = QString()) = 0;
...
signals:
    ...
    void authenticationComplete(bool authRes,QString msg);
};
