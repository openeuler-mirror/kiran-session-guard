...
## 编译
1.  安装编译依赖  
   `sudo yum install lightdm-qt5 lightdm-qt5-devel qt5-qtbase-devel libX11 libX11-devel libXtst libXtst-devel libXrandr libXrandr-devel libXcursor libXcursor-devel libXfixes libXfixes-devel glib2 glib2-devel gsettings-qt gsettings-qt-devel`
